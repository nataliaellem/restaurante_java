public class Restaurante {
    public static void main(String[] args) {
        ...
        mesas[1] = garcon[9].abrirMesa(2, 3);
        mesas[2] = garcon[8].abrirMesa(5, 1);
        ...
        garcon[9].fazerPedido(mesas[1], new Pedido("Pizza", 50));
        garcon[1].fazerPedido(mesas[3], new Pedido("Pizza", 50));
        ...
        mesas[11] = garcon[5].abrirMesa(87,50);
        for(int i = 0; i < 55; i++){
